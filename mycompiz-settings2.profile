...
s0_skydome = true
s0_skydome_image = /usr/share/backgrounds/ubuntu-mate-common/Grey-Wall.png
...
s0_left_window_key = <Control><Alt><Super>Left
s0_right_window_key = <Control><Alt><Super>Right
s0_up_window_key = <Control><Alt><Super>Up
s0_down_window_key = <Control><Alt><Super>Down
...
s0_top_images = /usr/share/backgrounds/ubuntu-mate-common/Grey-Wall-Logo.png;
s0_bottom_images = /usr/share/backgrounds/ubuntu-mate-common/Grey-Wall-Logo.png;
...
[core]
s0_active_plugins = core;composite;crashhandler;opengl;workspacenames;compiztoolbox;copytex;decor;grid;imgpng;matecompat;mousepoll;move;neg;place;regex;resize;session;shift;thumbnail;vpswitch;wall;wobbly;animation;commands;expo;ezoom;fade;scale;switcher;
